...
router.post("/analyze-resume", authMiddleware, async (req, res) => {
  try {
    ...
    const analysis = {
      ...
      skills: ["PHP", "Laravel", "Vue.js", "Node.js", "Python"],

      missingSkills: ["React", "TypeScript", "Docker"],

      suggestions: ["Add measurable achievements", "Show more React projects"],
...
router.get("/resume-analyses", authMiddleware, async (req, res) => {
  try {
